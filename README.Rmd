...
`ccmpp.tmb` is an implementation of a cohort component model of population projection (CCMPP) and the Wheldon _et al._'s [Bayesian Population Reconstruction](https://www.tandfonline.com/doi/full/10.1080/01621459.2012.737729) in the R package [Template Model Builder (TMB)](https://kaskr.github.io/adcomp/_book/Introduction.html).
